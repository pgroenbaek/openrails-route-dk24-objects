    ...
    for original_shape_name in trackshape_names:
        ...
        for line_idx in range(0, len(sfile_lines)):
            ...
            if ".ace" in sfile_line.lower():
                sfile_lines[line_idx] = replace_ignorecase(sfile_lines[line_idx], "DB_TrackSfs1.ace", "DB_Track1.ace")
                sfile_lines[line_idx] = replace_ignorecase(sfile_lines[line_idx], "DB_TrackSfs1s.ace", "DB_Track1s.ace")
                sfile_lines[line_idx] = replace_ignorecase(sfile_lines[line_idx], "DB_TrackSfs1w.ace", "DB_Track1w.ace")
                sfile_lines[line_idx] = replace_ignorecase(sfile_lines[line_idx], "DB_TrackSfs1sw.ace", "DB_Track1sw.ace")

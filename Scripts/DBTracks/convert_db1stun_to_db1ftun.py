    ...
    for original_shape_name in trackshape_names:
        ...
        for line_idx in range(0, len(sfile_lines)):
            ...
            if ".ace" in sfile_line.lower():
                sfile_lines[line_idx] = replace_ignorecase(sfile_lines[line_idx], "DB_TunTrackSfs1.ace", "DB_TunTrack1.ace")
                sfile_lines[line_idx] = replace_ignorecase(sfile_lines[line_idx], "DB_TunTrackSfs1s.ace", "DB_TunTrack1s.ace")
                sfile_lines[line_idx] = replace_ignorecase(sfile_lines[line_idx], "DB_TunTrackSfs1w.ace", "DB_TunTrack1w.ace")
                sfile_lines[line_idx] = replace_ignorecase(sfile_lines[line_idx], "DB_TunTrackSfs1sw.ace", "DB_TunTrack1sw.ace")

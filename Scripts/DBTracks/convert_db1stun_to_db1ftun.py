...
if __name__ == "__main__":
    ...
    shape_converted_path = ".\\Converted_from_DB1sTun_to_DB1ft"
    ffeditc_path = ".\\ffeditc_unicode.exe"
    match_shapes = "DB1s_*Tun*.s"
    ...
    for original_shape_name in trackshape_names:
        ...
        converted_shape_name = original_shape_name.replace("DB1s_", "DB1ft_")
        ...
        for line_idx in range(0, len(sfile_lines)):
            ...
            if ".ace" in sfile_line.lower():
                sfile_lines[line_idx] = tsu.replace_ignorecase(sfile_lines[line_idx], "DB_TunTrackSfs1.ace", "DB_TunTrack1.ace")
                sfile_lines[line_idx] = tsu.replace_ignorecase(sfile_lines[line_idx], "DB_TunTrackSfs1s.ace", "DB_TunTrack1s.ace")
                sfile_lines[line_idx] = tsu.replace_ignorecase(sfile_lines[line_idx], "DB_TunTrackSfs1w.ace", "DB_TunTrack1w.ace")
                sfile_lines[line_idx] = tsu.replace_ignorecase(sfile_lines[line_idx], "DB_TunTrackSfs1sw.ace", "DB_TunTrack1sw.ace")

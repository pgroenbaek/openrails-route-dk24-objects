...
if __name__ == "__main__":
    ...
    for original_shape_name in trackshape_names:
        ...
        sfile_text = replace_ignorecase(sfile_text, "DB_Track2s.ace", "DB_Track22s.ace")
        sfile_text = replace_ignorecase(sfile_text, "DB_Track2w.ace", "DB_Track22w.ace")
        sfile_text = replace_ignorecase(sfile_text, "DB_Track2sw.ace", "DB_Track22sw.ace")

...
if __name__ == "__main__":
    ...
    shape_converted_path = ".\\Converted_from_DB2ffrog_to_DB22ffrog"
    ffeditc_path = ".\\ffeditc_unicode.exe"
    match_shapes = "DB2f_*Frog*.s"
    ignore_shapes = ["*Tun*", "*Pnt*", "*DB2f_a1tFrog4_7dLft*", "*DB2f_a1tFrog4_7dRgt*"]
    ...
    for original_shape_name in trackshape_names:
        ...
        converted_shape_name = original_shape_name.replace("DB2f_", "DB22f_")
        ...
        sfile_text = tsu.replace_ignorecase(sfile_text, "DB_Track2.ace", "DB_Track22.ace")
        sfile_text = tsu.replace_ignorecase(sfile_text, "DB_Track2s.ace", "DB_Track22s.ace")
        sfile_text = tsu.replace_ignorecase(sfile_text, "DB_Track2w.ace", "DB_Track22w.ace")
        sfile_text = tsu.replace_ignorecase(sfile_text, "DB_Track2sw.ace", "DB_Track22sw.ace")

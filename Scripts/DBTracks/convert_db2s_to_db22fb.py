...
if __name__ == "__main__":
    ...
    shape_processed_path = "./Processed/DB22fb"
    ...
    for idx, sfile_name in enumerate(shape_names):
        ...
        # Convert .s file
        new_sfile_name = sfile_name.replace("DB2s_", "DB22fb_")
        ...
        new_sfile.replace_ignorecase("DB_TrackSfs2.ace", "DB_Track22.ace")
        new_sfile.replace_ignorecase("DB_TrackSfs2s.ace", "DB_Track22s.ace")
        new_sfile.replace_ignorecase("DB_TrackSfs2w.ace", "DB_Track22w.ace")
        new_sfile.replace_ignorecase("DB_TrackSfs2sw.ace", "DB_Track22sw.ace")

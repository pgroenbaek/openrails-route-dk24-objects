...
if __name__ == "__main__":
    ...
    shape_converted_path = ".\\Converted_from_DB2s_to_DB22fb"
    ...
    for original_shape_name in trackshape_names:
        ...
        converted_shape_name = original_shape_name.replace("DB2s_", "DB22fb_")
        ...
        for line_idx in range(0, len(sfile_lines)):
            ...
            if ".ace" in sfile_line.lower():
                sfile_lines[line_idx] = tsu.replace_ignorecase(sfile_lines[line_idx], "DB_TrackSfs2.ace", "DB_Track22.ace")
                sfile_lines[line_idx] = tsu.replace_ignorecase(sfile_lines[line_idx], "DB_TrackSfs2s.ace", "DB_Track22s.ace")
                sfile_lines[line_idx] = tsu.replace_ignorecase(sfile_lines[line_idx], "DB_TrackSfs2w.ace", "DB_Track22w.ace")
                sfile_lines[line_idx] = tsu.replace_ignorecase(sfile_lines[line_idx], "DB_TrackSfs2sw.ace", "DB_Track22sw.ace")

    ...
    for original_shape_name in trackshape_names:
        ...
        for line_idx in range(0, len(sfile_lines)):
            ...
            if ".ace" in sfile_line.lower():
                sfile_lines[line_idx] = replace_ignorecase(sfile_lines[line_idx], "DB_TrackSfs2.ace", "DB_Track22.ace")
                sfile_lines[line_idx] = replace_ignorecase(sfile_lines[line_idx], "DB_TrackSfs2s.ace", "DB_Track22s.ace")
                sfile_lines[line_idx] = replace_ignorecase(sfile_lines[line_idx], "DB_TrackSfs2w.ace", "DB_Track22w.ace")
                sfile_lines[line_idx] = replace_ignorecase(sfile_lines[line_idx], "DB_TrackSfs2sw.ace", "DB_Track22sw.ace")

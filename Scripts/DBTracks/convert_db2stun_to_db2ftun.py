    ...
    for original_shape_name in trackshape_names:
        ...
        for line_idx in range(0, len(sfile_lines)):
            ...
            if ".ace" in sfile_line.lower():
                sfile_lines[line_idx] = tsu.replace_ignorecase(sfile_lines[line_idx], "DB_TunTrackSfs2.ace", "DB_TunTrack2.ace")
                sfile_lines[line_idx] = tsu.replace_ignorecase(sfile_lines[line_idx], "DB_TunTrackSfs2s.ace", "DB_TunTrack2s.ace")
                sfile_lines[line_idx] = tsu.replace_ignorecase(sfile_lines[line_idx], "DB_TunTrackSfs2w.ace", "DB_TunTrack2w.ace")
                sfile_lines[line_idx] = tsu.replace_ignorecase(sfile_lines[line_idx], "DB_TunTrackSfs2sw.ace", "DB_TunTrack2sw.ace")

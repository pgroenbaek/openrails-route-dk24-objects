...
if __name__ == "__main__":
    ...
    shape_converted_path = ".\\Tunnels_500r1_25d"
    ...
    for original_shape_name in trackshape_names:
        ...
        converted_shape_name = original_shape_name.replace("r5d", "r1_25d")
        ...
        for line_idx in range(0, len(sfile_lines)):
            ...
            if "\t\tpoint (" in sfile_line.lower():
                ...
                distance_along_track = tsu.distance_along_curved_track(point, center_points, curve_radius, -1.25)
                
                if distance_along_track[0] < -1.25:
                    new_xz_position = tsu.get_new_position_from_angle(curve_radius, -1.25, point, center_points)
